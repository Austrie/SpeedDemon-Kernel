cmd_arch/arm/kernel/setup.o := arm-eabi-gcc -Wp,-MD,arch/arm/kernel/.setup.o.d  -nostdinc -isystem /home/austrie/myandroid/prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/bin/../lib/gcc/arm-eabi/4.4.0/include -Iinclude  -I/home/austrie/.Triumph_Kernel_sources/mykernel/arch/arm/include -include include/linux/autoconf.h -D__KERNEL__ -mlittle-endian -Iarch/arm/mach-msm/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -Werror -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -marm -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -Wframe-larger-than=1024 -fno-stack-protector -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fno-dwarf2-cfi-asm -fconserve-stack  -O1 -mtune=cortex-a8 -ftree-vectorize -ffast-math -fsingle-precision-constant -march=armv7-a -mfpu=vfpv3 -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(setup)"  -D"KBUILD_MODNAME=KBUILD_STR(setup)" -D"DEBUG_HASH=19" -D"DEBUG_HASH2=33" -c -o arch/arm/kernel/setup.o arch/arm/kernel/setup.c
...
deps_arch/arm/kernel/setup.o := \
  ...
  /home/austrie/.Triumph_Kernel_sources/mykernel/arch/arm/include/asm/cpu.h \
