...
@ GGC heuristics: --param ggc-min-expand=97 --param ggc-min-heapsize=126963
@ options passed:  -nostdinc -Iinclude
@ -I/home/austrie/.Triumph_Kernel_sources/mykernel/arch/arm/include
@ -Iarch/arm/mach-msm/include -iprefix
@ /home/austrie/myandroid/prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/bin/../lib/gcc/arm-eabi/4.4.0/
...
@ -isystem
@ /home/austrie/myandroid/prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/bin/../lib/gcc/arm-eabi/4.4.0/include
...
@ -Os -O1 -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -Werror
...
@ -ftree-vectorize -ffast-math -fsingle-precision-constant -fverbose-asm
...
@ -fpeephole -fpessimistic-inline-stack-limit -freciprocal-math
@ -freg-struct-return -fsched-interblock -fsched-spec
@ -fsched-stalled-insns-dep -fsection-anchors -fsingle-precision-constant
...
@ -ftree-ter -ftree-vect-loop-version -ftree-vectorize -funit-at-a-time
